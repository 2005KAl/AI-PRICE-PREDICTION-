...
def main() -> None:
    ensure_directories()
    df = split_dataset(load_master_dataset(), "multiunit")
    ...
    save_preprocessor(preprocessor, "multiunit_preprocessor.pkl")
    print(f"Multi unit preprocessing completed for {len(df)} rows")
